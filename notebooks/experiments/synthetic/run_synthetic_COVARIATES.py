...
# RESULTS
name_prefix = f"COVARIATES_LATENT_SYNTHETIC_optim{optimizer}_b1_0.5_b2_0.9_pretrain_epochs{n_epochs_pretrain_latents}synthetic_T{synthetic_T}_GRAD-CLIP_SIM:{intervention_type_simulation}INF:{intervention_type_inference}-slow_lr_{graph_type}_{edge_assignment}_{use_encoder}_{batch_size}_{lyapunov_penalty}"
SAVE_PLOT = True
CHECKPOINTING = True
...
#
gt_dyn, intervened_variables, samples, gt_interv, sim_regime, beta, _, _, covariates, covariate_weights = create_data(
    n_genes,
