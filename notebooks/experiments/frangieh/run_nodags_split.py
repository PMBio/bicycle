...
train_loader = torch.load(DATA_PATH / f"nodags_data_counts/{DATASET}/training_data/train_loader.pth")
validation_loader = torch.load(DATA_PATH / f"nodags_data_counts/{DATASET}/validation_data/validation_loader.pth")
test_loader = torch.load(DATA_PATH / f"nodags_data_counts/{DATASET}/test_data/test_loader.pth")
labels = np.load(DATA_PATH / f"nodags_data_counts/{DATASET}/labels.npy", allow_pickle=True)
