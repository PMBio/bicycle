...
plot_epoch_callback = 50
use_latents = True
# RESULTS
name_prefix = f"HEART-ORGANOID-TEST-4_celltype{cell_type}_batchsize{batch_size}_lyapunovpenalty{lyapunov_penalty}_latents{use_latents}_swa{swa}_seed{SEED}"
SAVE_PLOT = True
CHECKPOINTING = False
